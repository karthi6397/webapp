...
import { SimilarityMatches } from "@/components/ui/similarity-matches";
...
export default function AnalysisPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto flex flex-col gap-6">
      ...
      <Card>
        <CardContent className="p-6 flex flex-col gap-4">
          ...
          <Button className="w-full mt-4" onClick={handleAnalyze}>
            {hasSet2 && questionsText2.trim() !== "" ? "Compare" : "Analyze"}
          </Button>
        </CardContent>
      </Card>
      ...
      {/* ✅ Dual Set Comparison */}
      {result?.set1Result && result?.set2Result && (
        <div className="bg-white border p-6 rounded shadow mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mb-6">
            <DonutChart score={result.set1Result.totalScore} />
            <DonutChart score={result.set2Result.totalScore} />
          </div>

          {/* ✅ Injected clean similarity component */}
          <SimilarityMatches data={result.similarity} />
        </div>
      )}

      {/* ✅ Single Set Evaluation */}
      {result?.evaluations && !result?.set2Result && (
        <div className="bg-white border p-6 rounded shadow mt-6">
